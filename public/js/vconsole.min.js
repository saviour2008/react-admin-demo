...
!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        return (
          i(s, e) || (l && i(u, e) ? (s[e] = u[e]) : (s[e] = f('Symbol.' + e))),
          s[e]
        );
      };
    },
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t) {
        var n,
          ...
          b = e.global,
          h = e.stat;
        if ((n = b ? o : h ? o[p] || l(p, {}) : (o[p] || {}).prototype))
          for (u in t) {
            if (
              ((d = t[u]),
              (f = e.noTargetGet ? (v = r(n, u)) && v.value : n[u]),
              !s(b ? u : p + (h ? '.' : '#') + u, e.forced) && void 0 !== f)
            ) {
    ...
    function (e, t, n) {
      var o = {};
      (o[n(6)('toStringTag')] = 'z'), (e.exports = '[object z]' === String(o));
    },
    function (e, t, n) {
      var o, r, i;
      'undefined' != typeof globalThis
        ? globalThis
        : 'undefined' != typeof self && self,
        (r = [t, n(7), n(9), n(13), n(107), n(108), n(109)]),
        void 0 ===
          (i =
            'function' ==
                      ...
                      },
                      {
                        ...
                        value: function (e, t) {
                          ...
                          if (o.isString(t[0]) && i.test(t[0])) {
                            ...
                            for (var d = s.length + 1; d < t.length; d++)
                              c.push(t[d]);
                            t = c;
                          }
                          for (
                                    ...
                                    if (0 == i.children.length && e) {
                                      for (
                                        ...
                                        if (o.isArray(s)) {
                                          ...
                                          d = r.default.render(l.default, b);
                                        }
    ...
    function (e, t, n) {
      var o = n(2),
        ...
        a = n(5);
      e.exports = function (e, t) {
        for (var n = r(t), l = a.f, c = i.f, s = 0; s < n.length; s++) {
          var u = n[s];
          o(e, u) || l(e, u, c(t, u));
        }
      };
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t) {
        var n,
          ...
          c = 0,
          s = [];
        for (n in l) !o(a, n) && o(l, n) && s.push(n);
      ...
      function c(e, t) {
        for (var n = {}, o = [], r = 0; r < e.length; r++) {
          ...
          -1 !== f
            ...
            : a.push({ identifier: u, updater: h(d, t), references: 1 }),
            o.push(u);
        }
        return o;
      }
    ...
    function (e, t, n) {
      ...
      o(
        { target: 'Array', proto: !0, forced: !b || !h },
        {
          concat: function (e) {
            var t,
              n,
            ...
            for (t = -1, o = arguments.length; t < o; t++)
              if (g((i = -1 === t ? a : arguments[t]))) {
                if (d + (r = c(i.length)) > 9007199254740991)
                  throw TypeError('Maximum allowed index exceeded');
                for (n = 0; n < r; n++, d++) n in i && s(f, d, i[n]);
              } else {
    ...
    function (e, t, n) {
      var o = n(3),
        ...
        i = function (e, t) {
          var n = l[a(e)];
          return n == s || (n != c && ('function' == typeof t ? o(t) : !!t));
        },
    ...
    function (e, t, n) {
      ...
      var o = n(14),
        ...
        oe =
          ...
          u(function () {
            ...
            ? function (e, t, n) {
                var o = W(q, t);
                o && delete q[t], z(e, t, n), o && e !== q && z(q, t, o);
              }
            : z,
        re = function (e, t) {
        ...
        se = function (e, t) {
          ...
          if (n !== q || !f(X, o) || f(J, o)) {
            var r = W(n, o);
            return (
              !r || !f(X, o) || (f(n, F) && n[F][o]) || (r.enumerable = !0), r
            );
          }
        },
        ue = function (e) {
      ...
      (c ||
        (T(
          (H = function () {
            ...
            return l && ne && oe(q, t, { configurable: !0, set: n }), re(t, e);
          }).prototype,
          'toString',
          function () {
            return $(this).tag;
        ...
        l &&
          ...
          a || T(q, 'propertyIsEnumerable', ce, { unsafe: !0 }))),
      o({ global: !0, wrap: !0, forced: !c, sham: !c }, { Symbol: H }),
      I(_(ee), function (e) {
        V(e);
      }),
      o(
      ...
      H.prototype[G] || S(H.prototype, G, H.prototype.valueOf),
        M(H, 'Symbol'),
        (R[F] = !0);
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      e.exports = o
        ...
        : function (e, t) {
            i(e);
            for (var n, o = a(t), l = o.length, c = 0; l > c; )
              r.f(e, (n = o[c++]), t[n]);
            return e;
          };
    },
          ...
          return function (p, b, h, g) {
            for (
              var m,
                ...
                O = 0,
                k = g || l,
                E = t ? k(p, C) : n || d ? k(p, 0) : void 0;
              C > O;
              O++
            )
              if ((v || O in w) && ((y = x((m = w[O]), O, _)), e))
                if (t) E[O] = y;
                else if (y)
                  switch (e) {
                    case 3:
        ...
        void 0 ===
          (i =
            ...
            typeof (o = function (
                  ...
                  (n = [
                    {
                      ...
                      value: function () {
                        this.addPlugin(new b.default('default', 'Log'));
                        var e = this.option.defaultPlugins,
                          t = {
                            system: { proto: h.default, name: 'System' },
                            network: { proto: g.default, name: 'Network' },
                            element: { proto: m.default, name: 'Element' },
                            storage: { proto: y.default, name: 'Storage' },
                          };
                        if (e && r.isArray(e))
                          for (var n = 0; n < e.length; n++) {
                            var o = t[e[n]];
                      ...
                      value: function (e) {
                        ...
                        (e.vConsole = this),
                          ...
                          e.trigger('renderTab', function (n) {
                            t.tabList.push(e.id);
                            var o = i.default.render(s.default, {
                              id: e.id,
                              name: e.name,
                            });
                            i.default
                    ...
                    },
                    {
                      ...
                      value: function () {
                        if (this.isInited) {
                          var e = this;
                          (i.default.one('.vc-panel', this.$dom).style.display =
                            'block'),
                            setTimeout(function () {
              ...
              (k.VConsolePlugin = v.default),
                (k.VConsoleLogPlugin = p.default),
                (k.VConsoleDefaultPlugin = b.default),
                (k.VConsoleSystemPlugin = h.default),
                (k.VConsoleNetworkPlugin = g.default),
                (k.VConsoleElementPlugin = m.default),
            ...
            typeof (o = function (n) {
              ...
              Object.defineProperty(n, '__esModule', { value: !0 }),
                (n.default = function (e, t, n) {
                  ...
                  var d,
                    v = '',
                    p = o(document.getElementsByTagName('script'));
                  try {
                    for (p.s(); !(d = p.n()).done; ) {
                      var b = d.value;
                      if (b.nonce) {
                  ...
                  (h.innerHTML = a),
                    h.setAttribute('nonce', v),
                    document.documentElement.appendChild(h);
                  var g = __mito_result;
                  if ((document.documentElement.removeChild(h), !n)) {
                    var m = document.createElement('DIV');
                    (m.innerHTML = g), (g = m.children[0]);
                  }
                  return g;
                }),
                (e.exports = t.default);
    ...
    function (e, t, n) {
      ...
      'undefined' != typeof globalThis
        ? globalThis
        : 'undefined' != typeof self && self,
        (r = [t, n(9), n(7), n(13), n(116), n(117), n(118)]),
        void 0 ===
          (i =
            'function' ==
                        ...
                        if (e) {
                          ...
                          window.fetch = function (n, o) {
                            ...
                            if (
                              (r.isString(n)
                                ? ((s =
                                    (null == o ? void 0 : o.method) || 'GET'),
                                  (c = n),
                                  (u =
                                    (null == o ? void 0 : o.headers) || null))
                                : ((s = n.method || 'GET'),
                                  (c = n.url),
                                  (u = n.headers)),
                              (l = c.split('?')),
                            ...
                            if (l.length > 0) {
                              (a.name += '?' + l), (a.getData = {});
                              var b,
                                h = d((l = (l = l.join('?')).split('&')));
                              try {
                                for (h.s(); !(b = h.n()).done; ) {
                                  var g = b.value;
                                  (g = g.split('=')), (a.getData[g[0]] = g[1]);
                                }
                              } catch (e) {
                                h.e(e);
                              } finally {
    ...
    function (e, t, n) {
      ...
      'undefined' != typeof globalThis
        ? globalThis
        : 'undefined' != typeof self && self,
        (r = [t, n(120), n(121), n(13), n(123), n(124), n(7), n(9)]),
        void 0 ===
          (i =
            'function' ==
              ...
              var _ = (function (e) {
                ...
                function a() {
                  ...
                  for (
                    ...
                    n[r] = arguments[r];
                  var c = m((e = i.call.apply(i, [this].concat(n))));
                  return (
                    (c.isInited = !1),
                    (c.node = {}),
    ...
    function (e, t) {
      ...
      function _(e) {
        return (
          b ||
          (((n = new m((t = p).type, t.target)).addedNodes =
            t.addedNodes.slice()),
      ...
      (g.prototype = {
        observe: function (e, t) {
          ...
          o || ((o = new x(this, e, t)), r.push(o), this.nodes_.push(e)),
            o.addListeners();
        },
        disconnect: function () {
        ...
        (x.prototype = {
          enqueue: function (e) {
            ...
            } else (t = this.observer), f.push(t), u || ((u = !0), l(d));
            n[o] = e;
          },
